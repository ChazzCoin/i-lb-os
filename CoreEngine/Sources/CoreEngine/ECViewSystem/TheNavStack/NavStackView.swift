            ...
            detail: {
                NAV.getActiveView()?.getMainView()
                    ...
                    .navigationBarItems(leading: HStack {
                        ...
                        Button(action: {
                            main {
                                if NAV.navSize == NavStackSize.full_menu_bar {
                                    NAV.setSize(gps: NAV.gps, NavStackSize.full)
                                } else if NAV.navSize == NavStackSize.full {
                                    NAV.turnOnFloating(gps: NAV.gps)
                                } else {
                                    NAV.turnOffFloating(gps: NAV.gps)
                                }
                            }
                        }) {
